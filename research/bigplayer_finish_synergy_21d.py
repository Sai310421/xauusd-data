...
def main():
    ...
    base=pd.read_csv(SRC/'trades_TREND_REGIME.csv',parse_dates=['entry_time','exit_time'])
    ...
    # Test external boost strengths only. No signal formula/threshold tuning.
    rows=[]
    ...
    # Route confirmed and unconfirmed separately to expose whether confirmation is genuine edge.
